...
import 'package:sixpm_gym/View/widgets/date_picker.dart';
import 'package:sixpm_gym/View/home.dart';
import 'package:sixpm_gym/Controller/ProfileController.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:sixpm_gym/Model/globals_signup.dart' as global;
...
class _SignupPageState2 extends State<SignupPage2> {
  ...
  void createProfile() async {
    ...
    if (formState.validate()) {
      try {
        ProfileController().createProfile(firstnameController.text, lastnameController.text, username, email, _genderValue.toLowerCase(), global.dob, strengthController.text, interestController.text, _levelValue, user.uid);
